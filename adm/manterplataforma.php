...
<body>
    ...
    <div style="margin: 50px">
        ...
        <h1>Manter Plataforma</h1>
        <form method="post">
            <!-- inputs -->
            <input style="width: 90%;" type="text" name="descplataforma" id="desctipoitem" placeholder="Descrição da plataforma" />
            <!-------->

            <div style="float: right;">
                <button title="Inserir" name="salvarplataforma" class="reload" type="submit">
                    <div class="imginsert"></div>
                </button>


                <!--Botão de reload-->
                <button class="reload" name="buscarplataforma" type="submit" id="reload">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td align="right">
                                            <button type="submit" class="btn btn-outline-danger" name="excluirplataforma" value=<?php echo $rs->idplataforma ?>>Excluir</button>
                                        </td>
                                    </tr>
