    ...
    <div class="container">
      <div class="imgborder">
        <div class="inputs">
          ...
          <form method="POST" action="emailconfirmar.php" name="cas1" autocomplete="off" spellcheck="false">
            <!-- nome do usuario -->
            <label for="nomeuser">Nome</label>
            <input class="inputborder" type="text" maxlength="40" name="nomeuser" placeholder="Informe seu nome" required />
            <!------------------------->
            <label for="nomeuser">tipo conta</label>
            <select name=tipoconta>
            <?php
            $tipoconta = 'buscar';
            include_once('../classe/TipoContaSQL.php');
            if ($SQL->execute()) {
              ?>
             ...
             ?>
             <option value=<?php echo $rj->idtipo_conta?>><?php echo $rj->desc_tipo?></option>
             <?php
           }}
            ?>
            </select>
