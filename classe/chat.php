    ...
    <div class="section">
      <div class="columns">
        ...
        <div class="col-chat">
          ...
          <input name='mensagem' class="chat-input" contenteditable="" style="margin-top: 15px" ></input>
          <!--Fim do Input de texto, para o usuario inserir a mensagem-->
          <button name='mensagemuser' style="border: none;background-color: transparent; outline: none;"><svg style="position: absolute; right: 20; bottom: 10px; cursor: pointer;" id="enviar" xmlns="
