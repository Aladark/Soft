...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $tipite->SetIdTipoItem(filter_input(INPUT_POST,   'excluirtipoitem' ));
...
if ($salvar == 'sim') {
    try {
        ...
        $SQL->bindValue(1, $tipite->GetDescTipoItem());
...
// O codigo vai pegar as informaçoes do DAO e repasar para linha SQL.
if($buscartipoitem == "buscar" or isset($_POST['buscartipoitem'])) {
    try {
...
// O codigo vai pegar as informaçoes do DAO e repasar para linha SQL.
if (isset($_POST["simtipoitem"])  && $_POST['simtipoitem'] != null) {
    try {
        // bindParam e uma palavra reservada 
        // que quando estiver um "?" ela vai substituir por outro valor
        // ela serve para esse tipo de caso
        ...
        $SQL->bindValue(1, $tipite->getIdTipoItem());
