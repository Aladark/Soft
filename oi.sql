...
INSERT INTO `amizade` VALUES (2,1,'2022-05-10 20:00:27',NULL,1),(2,1,'2022-05-10 21:05:09',NULL,1),(2,1,'2022-05-10 21:07:07',NULL,1),(1,1,'2022-05-10 21:09:08',NULL,1),(1,2,'2022-05-10 21:30:20','2022-07-25 14:45:02',2),(2,1,'2022-05-11 20:30:20',NULL,1);
...
INSERT INTO `avaliacao_jogo` VALUES (13,1,1,'klç','2022-07-25');
...
CREATE TABLE `avaliativo_usuario` (
  `idavaliativo_usuario` int NOT NULL AUTO_INCREMENT,
  `fk_idusuario` int NOT NULL,
  `fk_idgrupos` int NOT NULL,
  `avaliacao` int NOT NULL,
  `comenatario` varchar(200) DEFAULT NULL,
  `denuncia` varchar(150) DEFAULT NULL,
  `revisasdo` int DEFAULT NULL,
  `data_avaliacao` date DEFAULT NULL,
  `fk_idmoderador` int DEFAULT NULL,
  PRIMARY KEY (`idavaliativo_usuario`),
...
INSERT INTO `avaliativo_usuario` VALUES (2,1,1,2,'corno do caralho','1',1,'2022-07-26',1),(3,1,1,2,'corno do caralho','1',1,'2022-07-26',1),(4,1,1,2,'corno do caralho','1',1,'2022-07-26',1),(5,1,1,2,'corno do caralho','1',NULL,NULL,NULL),(6,1,1,2,'corno do caralho','1',NULL,NULL,NULL),(7,1,1,2,'corno do caralho','1',NULL,NULL,NULL),(8,1,1,2,'corno do caralho','1',NULL,NULL,NULL);
...
INSERT INTO `conf_grupo` VALUES (1,'ADM',1,'2022-07-26'),(2,'MENBRO',1,'2022-07-26'),(1,'ADM',2,'2022-07-26'),(1,'ADM',3,'2022-07-26'),(1,'ADM',4,'2022-07-26'),(1,'ADM',5,'2022-07-26'),(2,'MEMBRO',5,'2022-07-26'),(2,'MEMBRO',2,'2022-07-26'),(2,'MEMBRO',3,'2022-07-26'),(2,'MEMBRO',4,'2022-07-26');
...
INSERT INTO `forma_pagamento` VALUES (1,'moeda');
...
INSERT INTO `grupos` VALUES (1,'gfhj','gfj',44,13,'2022-07-24'),(2,'fgh','fj',66,13,'2022-07-24'),(3,'fgh','ghf',99,13,'2022-07-24'),(4,'dfg','dfgdfg',2522,13,'2022-07-26'),(5,'dfg','fgdfg',22,14,'2022-07-26');
...
INSERT INTO `item` VALUES (1,19,'teste',20),(2,19,'teste2',20),(3,21,'cghjkgh',11),(4,19,'jjjj',11);
...
INSERT INTO `mensagem` VALUES (1,'BOM DIA, CALOTEIRO','00:00:00','2022-05-09',2,NULL),(1,'ACORDOU PUTA????','00:00:00','2022-05-09',2,NULL),(1,'scvsdv','00:00:00','2022-05-10',2,NULL),(1,'asd','00:00:00','2022-05-10',2,NULL),(1,'dfgdfg','16:58:37','2022-07-25',2,NULL),(1,'tyjtj','23:46:32','2022-07-26',2,NULL),(1,'tyutyj','23:46:36','2022-07-26',2,NULL),(1,'ppppp','23:46:43','2022-07-26',2,NULL),(1,'gfjgf','00:52:38','2022-07-27',2,NULL);
...
INSERT INTO `mensagem_topico` VALUES (1,'fghfgh',2,1,'2022-07-27'),(2,'bgjçloç',2,1,'2022-07-27'),(3,'hjkçkjç',2,1,'2022-07-27'),(4,'jkljkl',2,1,'2022-07-27');
...
INSERT INTO `meus_jogos` VALUES (15,1,NULL),(15,1,NULL),(14,1,NULL),(15,1,NULL),(14,1,NULL),(14,1,NULL),(13,1,NULL),(13,1,NULL),(15,1,NULL),(14,1,NULL),(15,1,NULL),(14,1,NULL),(15,1,NULL);
...
CREATE TABLE `new_table` (
  ...
  `tempo_entrada` time NOT NULL,
  `data_saida` date DEFAULT NULL,
  `tempo_saida` time DEFAULT NULL,
  PRIMARY KEY (`fk_idusuario`),
...
INSERT INTO `tipo_item` VALUES (19,'mapa'),(20,'sdfsdf'),(21,'sdfsdf'),(22,'mapa');
...
INSERT INTO `topico` VALUES (1,'teste','2022-07-24',1),(2,'corno','2022-07-24',1);
...
INSERT INTO `usuario` VALUES (1,'XpMax','12345','mateus','mateus3007araujo@gmail.com','2003-07-30',1,'masculino',1,'null',200),(2,'Kreobio','123','Gustavo','rexgame470@gmail.com','2003-12-01',1,'masculino',1,'null',400);
...
INSERT INTO `venda` VALUES (2,'2022-07-25',1,1,1),(3,'2022-07-26',1,1,2),(4,'2022-07-26',1,1,4),(5,'2022-07-26',1,1,3),(6,'2022-07-26',1,1,4),(7,'2022-07-27',1,1,1),(8,'2022-07-27',1,1,1),(9,'2022-07-27',1,1,1),(10,'2022-07-27',1,1,3),(11,'2022-07-27',1,1,2),(12,'2022-07-27',1,1,1),(13,'2022-07-27',1,1,1),(14,'2022-07-27',1,1,1),(15,'2022-07-27',1,1,1),(16,'2022-07-27',1,1,1),(17,'2022-07-27',1,1,1),(18,'2022-07-27',1,1,1),(19,'2022-07-27',1,1,1);
...
-- Dump completed on 2022-07-27 10:45:24
