    ...
    <div class="section">
      <div class="columns">
        ...
        <div class="col-chat">
          ...
          <button name='enviarmensage' style="border: none;background-color: transparent; outline: none;"><svg style="position: absolute; right: 20; bottom: 10px; cursor: pointer;" id="enviar" xmlns="
